...
import 'package:khalih/ui/kasir/antrian.dart'; // Make sure to import the Antrian page
                ...
                setState(() {
                  ...
                  if (showOrders) {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => Antrian()),
                    );
                  }
                });
              },
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(bottom: 0, right: 1),
